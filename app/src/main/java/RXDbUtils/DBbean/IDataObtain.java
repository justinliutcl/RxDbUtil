...
public interface IDataObtain {
    ...
    abstract class DataChanged<T> implements IDataObtain.IDBResCallback<T> {
        Collection<IDbChangeCallback> mListeners = null;
        IDataObtain.IDBResCallback<T> mCallBack;

        public DataChanged(@NonNull Collection<IDbChangeCallback> listeners, IDataObtain.IDBResCallback<T> callBack) {
